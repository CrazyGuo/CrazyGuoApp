		...
		return {
			...
			controller : function($scope, $attrs, $element) {
				...
				$scope.slideHasChanged = function(index){
					...
					switch(index){
						case 0:
							$ionicSlideBoxDelegate.$getByHandle('imgSlider').start()
							$scope.$broadcast('mainLoad')
							break;
						case 1:
							$ionicSlideBoxDelegate.$getByHandle('imgSlider').stop();
							$scope.$broadcast('nlLoad');
							break;
						case 2:
							$ionicSlideBoxDelegate.$getByHandle('imgSlider').stop();
							$scope.$broadcast('plLoad');
							break;
						case 3:
							$ionicSlideBoxDelegate.$getByHandle('imgSlider').stop();
							$scope.$broadcast('vlLoad');
							break;
						case 4:
							$ionicSlideBoxDelegate.$getByHandle('imgSlider').stop();
							$scope.$broadcast('glLoad');
							break;
					}
				};
				...
				$timeout(function(){
					$ionicSlideBoxDelegate.$getByHandle('tabSlider').enableSlide(0);
				},0);
			}
		};
